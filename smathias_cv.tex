...
\begin{innerlist}
\item Junior faculty position $\approx$ Assistant Professor at other US institutions
\item Joint appointment with \href{http://www.childrenshospital.org/}{Boston Children's Hospital} (see below)
...
\begin{innerlist}
\item Joint appointment with Harvard Medical School (see above)\\
\end{innerlist}
\end{outerlist}
\end{bibsection}
...
\begin{bibsection}
\item \href{http://www.uni-leipzig.de/~acn/}{ACN} travel award (\texteuro 800) \hfill{Apr. 2014}
...
\section{Manuscripts in preparation\\(2 items)}
\begin{bibsection}
\item \textbf{Mathias, S. R.}, Knowles, E. E., Kent, J. W. Jr, McKay,  D. R., Curran J. E, Almeida, M. A., Dyer, T. D., G\"oring, H. H., Olvera, R. L., Duggirala, R., Fox, P. T., Almasy, L., Blangero, J. \& Glahn, D. C. Minimal relationship between brain gyrification and general cognitive ability in humans. Under review at \emph{Cerebral Cortex}.

\item \textbf{Mathias, S. R.}, Varghese, L.,  Micheyl, C., \& Shinn-Cunningham, B. G. On the utility of perceptual anchors during pure-tone frequency discrimination. Under review at \emph{The Journal of the Acoustical Society of America}.
\end{bibsection}

\section{Publications\\(39 items)}
\begin{bibsection}
...
\item Groman, S. M., Massi, B., \textbf{Mathias, S. R.}, Lee, D., \& Taylor, J. R. (2019). Model-free and model-based influences in addiction-related behaviors. \emph{Biological Psychiatry}, \emph{85}(11), 936--945. DOI:~\href{https://doi.org/10.1016/j.biopsych.2018.12.017}{10.1016/j.biopsych.2018.12.017}. PMID:~\href{https://www.ncbi.nlm.nih.gov/pubmed/?term=30737015}{30737015}.
\item Rodrigue, A. L., Knowles, E. E., Mollon, J., \textbf{Mathias, S. R.}, Koenis, M. M., Peralta, J. M., Leandro, A. C., Fox, P. T., Sprooten, E., Kochunov, P., Olvera, R. L., Duggirala, R., Almasy, L., Curran, J. E., Blangero, J., \& Glahn, D. C. (2019). Evidence for genetic correlation between human cerebral white matter microstructure and inflammation. \emph{Human Brain Mapping}. DOI:~\href{https://doi.org/10.1002/hbm.24694}{10.1002/hbm.24694}. PMID:~\href{https://www.ncbi.nlm.nih.gov/pubmed/?term=31187567}{31187567}.
\item \textbf{Mathias, S. R.} \& von Kriegstein, K. (2019). Voice processing and voice-identity recognition. In K. Siedenburg, C. Saitis, S. McAdams, A. Popper, R. Fay (Eds.) \emph{Timbre: Acoustics, perception, and cognition} (Springer handbook of auditory research vol.~69, pp.~175--209). Cham, Switzerland:~Springer. %DOI:~\href{https://doi.org/10.1007/978-3-030-14832-4_7}{10.1007/978-3-030-14832-4_7}.
...
\begin{innerlist}
\item Python package built on top of PyMC3 to perform Bayesian estimation and hypothesis testing of variance components for quantitative genetics (i.e., ``Bayesian SOLAR")
\end{innerlist}
\end{outerlist}
\end{bibsection}
...
\end{innerlist}
\end{outerlist}
\item \href{https://www.nimh.nih.gov/}{National Institute of Mental Health}
\begin{outerlist}
...
\section{Completed\\Support\\(last 4 years)}
\begin{bibsection}
...
\item Role: Postdoctoral Associate
\end{innerlist}
\end{outerlist}
